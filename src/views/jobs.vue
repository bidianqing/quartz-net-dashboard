<template>
  ...
  <el-table :data="jobData" style="width: 100%">
    ...
    <el-table-column fixed="right" label="Operations" min-width="120">
      <template #default="scope">
        <el-button link type="primary" size="small" @click="visibleTriggerJobDialog(scope.row)">
            TriggerJob
        </el-button>
      </template>
    </el-table-column>
  ...
  >
    <el-form :model="triggerJobDialogOptions.form">
        <el-table :data="triggerJobDialogOptions.form.variables" style="width: 100%">
            ...
            <el-table-column>
                <template #default="scope">
                    <el-button type="danger" :icon="Delete" circle @click="removeVariable(scope.row)"/>
                </template>
            </el-table-column>
        </el-table>
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button @click="triggerJobDialogOptions.visible = false">Cancel</el-button>
